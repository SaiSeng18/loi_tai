      ...
      <div className="body">
        ...
        <div className="card">
          ...
          className="content-container">
            <motion.h1 key={1} variants={item}>LOI TAI - SS01</motion.h1>
            <motion.p  key={2} variants={item} className="content">LT&apos;s first season is called &apos;Dynamics&apos;. <br /> Check out some of our looks ranging from the studio to the streets. <br /> See how our basic tees are worn…</motion.p>
            <Link href="/shop" passHref><motion.a key={3} variants={item}>Visit Links</motion.a></Link>
          </motion.div>
        </div>
        ...
        <div className="card">
          ...
          viewport={{once: true, amount: 0.5}} 
          className="content-container">
            <motion.h1 key={1} variants={item}>FIRST PRODUCTS</motion.h1>
